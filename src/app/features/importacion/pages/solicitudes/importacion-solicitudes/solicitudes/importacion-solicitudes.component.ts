...
@Component({
  ...
  templateUrl: './solicitudes/importacion-solicitudes.component.html',
  styleUrl: './solicitudes/importacion-solicitudes.component.scss',
})
export class ImportacionSolicitudesComponent {
