...
@Component({
  ...
  templateUrl: './proveedores/importacion-proveedores.component.html',
  styleUrl: './proveedores/importacion-proveedores.component.scss',
})
export class ImportacionProveedoresComponent {
